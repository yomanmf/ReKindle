...
ReKindle routes authenticated AI, OCR, storage, Microsoft To Do, and third-party API proxy requests through Yandex API Gateway and Yandex Cloud Functions. Interactive Z-code stories use a dedicated Yandex Function backed by Yandex Object Storage. Cloudflare Worker sources and Wrangler manifests have been removed; the frontend must not call `workers.dev`.
